      ...
      <main className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-6 pb-20">
        ...
        <section className="grid gap-6 md:grid-cols-2">
          <div className="rounded-3xl border border-black/10 bg-white/60 p-6 backdrop-blur">
            ...
            <p className="mt-3 text-xs text-[var(--muted)]">
              Already lost it? If it has a return tag, check status in Report Lost. If not, use the
              owner‑verified flow and share hints with the finder.
            </p>
          </div>
          <div className="rounded-3xl border border-black/10 bg-white/60 p-6 backdrop-blur">
            <h2 className="text-xl font-semibold">If you found something (with a tag)</h2>
            <ol className="mt-3 space-y-2 text-sm text-[var(--muted)]">
        ...
        <section className="rounded-3xl border border-black/10 bg-white/60 p-6 backdrop-blur">
          ...
          <p className="mt-2 text-sm text-[var(--muted)]">
            ...
            (or that a finder saw the return tag). This keeps the registry public and safe to use.
          </p>
        </section>
        ...
        <section className="rounded-3xl border border-black/10 bg-white/60 p-6 backdrop-blur">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-black/10 bg-white/80 p-4">
              <h3 className="text-sm font-semibold">Fast return (return tag)</h3>
              <p className="mt-2 text-sm text-[var(--muted)]">
                Best for MacBooks, phones, cards. A return tag makes the return instant and fully
                trustless.
              </p>
            </div>
            <div className="rounded-2xl border border-black/10 bg-white/80 p-4">
